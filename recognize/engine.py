...
image1 = face_recognition.load_image_file(os.path.abspath("C:/Users/harsh/PycharmProjects/Face-Mask-Detection/recognize/images/shreyas.jpg"))
image1_face_encoding = face_recognition.face_encodings(image1)[0]

image2 = face_recognition.load_image_file(os.path.abspath("C:/Users/harsh/PycharmProjects/Face-Mask-Detection/recognize/images/harsh.jpg"))
